...
?>
<div class="container">
  <center><h2>SİPARİŞ DÜZENLEME iŞLEMİNİ KABUL EDİYORMUSUNUZ ?</h2></center><br>
<div class="well well-sm"><?php if($resim_onay==1){echo "<b>Resim Eklendi</b><br>";}else{ echo "<b>Resim Eklenemedi</b><br>";} echo "Sipariş Gelen Yer: {$yeri_tablo['sip_yeri_adi']} <br>
 ...
 Adres: $adres <br> Aciliyet: {$aciliyet_tablo['aciliyet_adi']} <br> Şube: $sube <br> <b>Fiyat: $fiyat</b>" ;?> </div>
   ...
   <form  action="/siparis_duzenle_kaydet_ok.php" method="post" style="display:inline-block;">
   ...
   <input type="text" hidden="on" value="<?php echo $kargo_tarih; ?>" name="kargo_tarih"></input>
   ...
   <input type="text" hidden="on" value=<?php echo $rutbe_no; ?> name="rutbe_no"></input>
