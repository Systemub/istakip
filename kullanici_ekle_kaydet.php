...
?>
<div class="container">
   <center><h2 style='background-color: #009900;'>KULLANICI EKLEME</h2> <h2>iŞLEMİNİ KABUL EDİYORMUSUNUZ ?</h2></center><br>
<div class="well well-sm"><?php echo "Kullanici Adi: $kullanici_adi | Kullanici Şifre: $kullanici_sifre | Adi: $adi | Soyadi: $soyadi |  Şube: $sube | Görev: $rutbe_adi";?> </div>
   ...
   <form  action="/kullanici_ekle_kaydet_ok.php" method="post" style="display:inline-block;">
